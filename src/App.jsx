...
const Hero = () => (
  <section className="relative h-screen overflow-hidden">
    ...
    <div className="relative z-10 flex flex-col h-full px-4 max-w-4xl mx-auto pt-32 pb-10 md:pb-12">
      
      {/* 👑 ここが「ド真ん中」のエリア（flex-1 で上下の余白を自動で押し広げる） */}
      <div className="flex-1 flex flex-col justify-center items-center">
        <h1 className="text-4xl md:text-6xl lg:text-7xl text-white font-light leading-tight text-center drop-shadow-lg -translate-y-32 md:-translate-y-32">
