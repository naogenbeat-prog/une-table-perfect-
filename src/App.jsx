...
const Hero = () => (
  <section className="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-20">
      ...
      <p className="text-sm md:text-2xl text-stone-300 font-light mb-40 max-w-2xl mx-auto leading-loose tracking-wide">厳選された旬の食材を使用し目にも楽しい彩をお届け致します。<br className="hidden md:block" />特別な日を彩る最高峰のケータリング体験をお届けします。</p>
