...
const Hero = () => (
  <section className="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-20">
      <h2 className="text-amber-500 tracking-[0.3em] text-xs md:text-base uppercase mb-4">Premium Catering Service</h2>
      <h1 className="text-5xl md:text-7xl lg:text-7xl text-white font-light leading-tight mb-16 drop-shadow-lg">華やかな装いを <br />あなただけの空間へ </h1>
      <p className="text-lg md:text-2xl text-stone-300 font-light mb-40 max-w-2xl mx-auto leading-loose tracking-wide">厳選された旬の食材を使用し、目にも楽しい彩とともに。。<br className="hidden md:block" />特別な日を彩る最高峰のケータリング体験をお届けします。</p>
  ...
  <section id="concept" className="py-24 md:py-40 px-6 md:px-12 max-w-7xl mx-auto">
    <div className="flex flex-col md:flex-row items-center gap-12 md:gap-24 mb-12">
      ...
      <div className="w-full md:w-1/2">
        ...
        <h2 className="text-5xl md:text-5xl text-amber-500 font-light leading-snug mb-20">一瞬の感動を<br />永遠の思い出に</h2>
        <p className="text-white-loose mb-8 font-light text-base md:text-lg">{CONFIG.brandName}（ユヌ・ターブル）は、フランス語で「一つのテーブル」を意味します。私たちは、厳選された食材を確かな技術で、目にも美しい一皿へと昇華させます。</p>
        <p className="text-white leading-loose font-light text-sm md:text-lg">企業様のレセプションパーティーから、各団体様の大切な懇親会。「一つのテーブル」を囲むかけがえのない時間に、究極のおもてなしをお約束いたします。</p>
      </div>
    </div>
  </section>
);
