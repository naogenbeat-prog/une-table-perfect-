...
const Hero = () => (
  <section className="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-20">
      ...
      <h1 className="text-6xl md:text-6xl lg:text-7xl text-white font-light leading-tight mb-16 drop-shadow-lg">華やかな装いを <br />あなただけの空間へ </h1>
      <p className="text-lg md:text-2xl text-stone-300 font-light mb-40 max-w-2xl mx-auto leading-loose tracking-wide">厳選された旬の食材を使用し目にも楽しい彩をお届け致します。<br className="hidden md:block" />特別な日を彩る最高峰のケータリング体験をお届けします。</p>
