...
const Hero = () => (
  <section className="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-30">
      ...
      <p className="font-sans text-base md:text-2xl text-white font-light mb-10 max-w-2xl mx-auto leading-loose tracking-wide">厳選された旬の食材を使用し、目にも楽しい彩を添えて。<br className="hidden md:block" /> 特別な日を彩る最高峰のケータリングをお届け致します。</p>
  ...
  <section id="menu" className="py-24 md:py-32 bg-zinc-950 px-6">
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          { name: "立食携帯", price: "¥4,500~", desc: "洗練されたスタンダードコース。軽やかに楽しめます。", items:["フィンガーフード４品", "串もの４品", "寿司３品", "デザート"] },
          { name: "立食・着席", price: "¥6,000~", desc: "当店のスペシャリティ。厳選食材を用いた華やかなセッティング。", items:["フィンガーフード６品", "串もの６品", "寿司３品", "デザート2種"] },
          { name: "着席形態", price: "¥8,000~", desc: "完全オーダーメイド. お客様の想いを形に致します。。", items:["食材指定可能", "飲料指定可能", "着席配置可能", "演出指定可能"] },
        ].map((plan, i) => (
