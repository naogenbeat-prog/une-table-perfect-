...
const Hero = () => (
  <section className="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-15">
      <h2 className="text-amber-500 tracking-[0.3em] text-sm md:text-lg uppercase mb-40">Premium Catering Service</h2>
      ...
      <p className="text-xl md:text-2xl text-white font-light mb-20 max-w-2xl mx-auto leading-loose tracking-wide">厳選された旬の食材を使用し、目にも楽しい彩を添えて。<br className="hidden md:block" /> 特別な日を彩る最高峰のケータリングをお届け致します。</p>
