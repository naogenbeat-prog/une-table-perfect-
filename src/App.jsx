...
const Hero = () => (
  <section className="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-40">
      <h2 className="text-amber-500 tracking-[0.3em] text-xs md:text-base uppercase mb-12">Premium Catering Service</h2>
      ...
      <p className="text-xl md:text-2xl text-stone-100 font-light mb-30 max-w-2xl mx-auto leading-loose tracking-wide">厳選された旬の食材を使用し、目にも楽しい彩とともに。<br className="hidden md:block" />特別な日を彩る最高峰のケータリング体験をお届け致します。</p>
