...
const Hero = () => (
  <section className="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-20">
      ...
      <p className="text-sm md:text-2xl text-stone-300 font-light mb-8 max-w-2xl mx-auto leading-loose tracking-wide">厳選された旬の食材を使用し目にも楽しい彩をお届けします。<br className="hidden md:block" />特別な日を彩る最高峰のケータリング体験をお届けします。</p>
  ...
  <section id="concept" className="py-24 md:py-40 px-6 md:px-12 max-w-7xl mx-auto">
    <div className="flex flex-col md:flex-row items-center gap-12 md:gap-24 mb-32">
      ...
      <div className="w-full md:w-1/2">
        ...
        <h2 className="text-3xl md:text-5xl text-white font-light leading-snug mb-12">一瞬の感動を<br />永遠の思い出に</h2>
