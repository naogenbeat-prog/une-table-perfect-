...
const Hero = () => (
  <section className="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-36">
      <h2 className="text-amber-500 tracking-[0.3em] text-sm md:text-lg uppercase mb-24">Premium Catering Service</h2>
      <h1 className="text-4xl md:text-7xl lg:text-7xl text-white font-light leading-tight mb-24 drop-shadow-lg">華やかな装いを <br />あなただけの空間へ </h1>
